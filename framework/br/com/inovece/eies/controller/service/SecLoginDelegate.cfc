component output="false" extends="BaseDelegate" {
	...
	Variables.CLASSNAME = 'br.com.inovece.eies.bussiness.remote.SecLoginBeanRemote';
	...
	public array function getDataAjax(Numeric start){
		return getData(arguments.start,10, {});
	}
